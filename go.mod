...
require (
	...
	github.com/numtide/multigres-operator/pkg/webhook v0.0.0-20260210092054-f7ad64000b6d
	k8s.io/api v0.35.0
...
require (
	...
	github.com/numtide/multigres-operator/pkg/testutil v0.0.0-20260210092054-f7ad64000b6d // indirect
