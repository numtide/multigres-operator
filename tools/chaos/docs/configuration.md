...
All flags, environment variables, thresholds, and tunable parameters for the chaos tool.
...
|------|---------|-------------|-------------|
| `--level` | `0` | `CHAOS_LEVEL` | Operating level: 0=observer, 1=exerciser, 2=fault, 3=adversarial |
...
| `--dry-run` | `false` | — | Level 1+: log planned mutations without executing |
| `--scenario-cooldown` | `30s` | — | Level 1+: wait time between scenarios |
...
| `EventReasonPodReplaced` | `PodReplaced` | Drained pod was replaced |
