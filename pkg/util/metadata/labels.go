...
const (
	...
	//
	// It is stamped on each pod to record the reload-hash that pod is confirmed
	// current on (updated after the multipooler ReloadConfig RPC verifies the
	// running server carries the change).
