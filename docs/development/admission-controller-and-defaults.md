...
2. **Static Defaults:** Materialize `TopologyPruning` (enabled), `PVCDeletionPolicy` (Retain/Delete), `Backup` (filesystem /backups), and `DurabilityPolicy` ("AT_LEAST_2") if not set.
