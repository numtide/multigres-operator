...
| **Pool replica count floor** | ✅ **Validated** | CRD enforces minimum=1. Webhook warns for readWrite pools with <3 (AT_LEAST_2 quorum requires 1 primary + 2 standbys for rolling upgrades). |
