...
const (
	...
	DefaultPostgresImage = "ghcr.io/multigres/pgctld:sha-d9b8ff2"
	...
	DefaultMultiAdminImage = "ghcr.io/multigres/multigres:sha-d9b8ff2"
	...
	DefaultMultiOrchImage = "ghcr.io/multigres/multigres:sha-d9b8ff2"

	// DefaultMultiPoolerImage is the default container image for the MultiPooler component.
	DefaultMultiPoolerImage = "ghcr.io/multigres/multigres:sha-d9b8ff2"

	// DefaultMultiGatewayImage is the default container image for the MultiGateway component.
	DefaultMultiGatewayImage = "ghcr.io/multigres/multigres:sha-d9b8ff2"
)
