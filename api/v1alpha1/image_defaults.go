...
const (
	...
	DefaultPostgresImage = "ghcr.io/multigres/pgctld:sha-4bca1d5"
	...
	DefaultMultiAdminImage = "ghcr.io/multigres/multigres:sha-4bca1d5"
	...
	DefaultMultiOrchImage = "ghcr.io/multigres/multigres:sha-4bca1d5"

	// DefaultMultiPoolerImage is the default container image for the MultiPooler component.
	DefaultMultiPoolerImage = "ghcr.io/multigres/multigres:sha-4bca1d5"

	// DefaultMultiGatewayImage is the default container image for the MultiGateway component.
	DefaultMultiGatewayImage = "ghcr.io/multigres/multigres:sha-4bca1d5"
)
